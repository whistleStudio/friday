...
const store = new Vuex.Store({
	state: {
		...
		_gameInfo: {
			...
			fightIdx: {},
			isInitOk: true, isBoss: false, isAdvsOk: false, isStopDraw: false, isReleaseEnv: false	
		},
		_cards: cards
	},
	getters: {
				...
				success (res) {
					if (res.statusCode<400) {
						if (!res.data.err) {
							...
							context.commit("changeObjVal", {k1:"_userInfo", k2:"lastGameRes", v:res.data.lastGameRes})
